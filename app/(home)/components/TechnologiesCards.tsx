...
export default function TechnologiesCards() {
    ...
    const cardItems: TechnologiesCardInterface[] = [
        ...
        },
        {
            ...
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="h-8 w-8" style={{ height: 32}}>
        ...
        },
        {
            ...
            svg: (
                <svg fill={theme === "dark" ? "#FFFFFF" : "#100F13"} width="32" height="32" viewBox="0 0 512 512"
                     xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            description:
                "OAuth 2.0 authentication through Google and GitHub using NextAuth.js.",
